...
const BancaMovilPago = ({ route, navigation }) => {
  ...
  const copiarNumero = async () => {
    if (!numeros.banca) {
      Alert.alert("Error", "Número de Banca Móvil no disponible");
      return;
    }
    await Clipboard.setStringAsync(numeros.banca);
  ...
  return (
    <Box flex={1} bg="white" p={6}>
      ...
      <VStack space={4}>
        ...
        <Button bg={'#36387a'} borderRadius={10} onPress={seleccionarImagen}>
